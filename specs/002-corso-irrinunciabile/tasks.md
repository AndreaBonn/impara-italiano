...
| ID | Dip. | Req. | Task | File | Stima | Verify | Rischio |
|---|---|---|---|---|---|---|---|
| T080 | T006 | O3 DoD 6, D6 | **Spike S1**: `getUserMedia` e `SpeechRecognition` insieme sulla stessa pagina; formati `MediaRecorder` su Chromium e su WebKit | - | 4h | Esito scritto in questa riga: praticabile o no, su quali browser, con quale mime. Se lo scoring non è praticabile, **T084 esce dal piano** e la DoD resta soddisfatta lo stesso | **alto** |
