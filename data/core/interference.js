...
window.INTERFERENCE = [
  ...
  { id: "fermare", it: "fermare", ex: "La polizia ci ha fermati al confine.", for: ["fr"] },
  ...
  { id: "nota", it: "la nota", ex: "Ho lasciato una nota sul tavolo.", for: ["de"] },
  ...
  { id: "colazione", it: "la colazione", ex: "A colazione bevo solo un caffè.", for: ["fr", "de", "pl"] },
  { id: "pensione", it: "la pensione", ex: "Abbiamo dormito in una pensione al mare.", for: ["fr", "pl"] },
  ...
  { id: "casa", it: "la casa", ex: "Torno a casa verso le sette.", for: ["pl", "de"] },
  { id: "pila", it: "la pila", ex: "La pila del telecomando è scarica.", for: ["pl"] },
  { id: "presente", it: "il presente", ex: "Pensiamo al presente, non al passato.", for: ["pl"] },
  { id: "preservativo", it: "il preservativo", ex: "In farmacia vendono anche i preservativi.", for: ["en", "fr", "de"] },
  { id: "simpatico", it: "simpatico", ex: "Il tuo amico è molto simpatico.", for: ["en", "fr", "de"] },
  { id: "attitudine", it: "l'attitudine", ex: "Ha una grande attitudine per la musica.", for: ["en", "fr", "de"] },
  { id: "disgrazia", it: "la disgrazia", ex: "È stata una disgrazia, non è colpa sua.", for: ["en", "fr"] },
  { id: "romanzo", it: "il romanzo", ex: "Ho finito il romanzo che mi hai prestato.", for: ["en"] },
  { id: "abusivo", it: "abusivo", ex: "Hanno costruito una casa abusiva sulla spiaggia.", for: ["en"] },
  { id: "comprensivo", it: "comprensivo", ex: "Il capo è stato comprensivo con me.", for: ["en"] },
  { id: "cava", it: "la cava", ex: "Il marmo viene da una cava vicino a Carrara.", for: ["fr"] },
  { id: "salato", it: "salato", ex: "La minestra è troppo salata.", for: ["fr", "de"] }
];
