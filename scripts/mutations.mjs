...
const MUTACJE = [
  ...
  { plik: FLASH, test: T_FLASH, opis: "listening: the system voice asked by ear anyway",
    z: 'return !!hasRecording && voiceSource !== "system";', na: "return !!hasRecording;" },
  { plik: FLASH, test: T_FLASH, opis: "listening: without a recording",
    z: 'return !!hasRecording && voiceSource !== "system";', na: 'return voiceSource !== "system";' },
  { plik: FLASH, test: T_FLASH, opis: "listening: a heard pick with no distractors",
    z: '      family = ["flip"];\n', na: '      family = avail.audio ? ["flip", "listen-choice"] : ["flip"];\n' },
  { plik: FLASH, test: T_FLASH, opis: "grades: a heard pick self-graded",
