...
LINGUAI.addReadings([

  {
    ...
    glossIt: ["la sveglia", "la lavanderia", "la tenda", "la vetrina", "la piega", "il ritiro"],
    lexIt: ["svegliarsi", "colazione", "biscotto", "portone", "ritardo", "cliente", "anziana", "nipote", "quaderno", "macchia", "lezione", "paese", "economico"],
    questions: [
