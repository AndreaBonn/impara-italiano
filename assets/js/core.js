...
(function (global) {
  ...
  /* ---------------- Rejestr kursu ----------------
     Struktura kursu i dociąganie plików poziomu siedzą w registry.js.
     Tutaj potrzebny jest sam indeks słownictwa (cardTr szuka w nim glosy
     w nowym języku) — i ten sam obiekt idzie dalej jako Core.registry.
     ------------------------------------------------------- */
